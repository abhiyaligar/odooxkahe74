...
For a detailed step-by-step manual testing guide with payload schemas, error loop validation scenarios, and API examples, refer to [MANUAL_TESTING.md](file:///C:/Users/91974/Desktop/odooxkahe74/backend/docs/MANUAL_TESTING.md).
